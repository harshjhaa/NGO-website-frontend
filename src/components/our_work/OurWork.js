        ...
        <div className="home-feature-content-1-container">
          ...
          <div className="home-feature-content-1-content">
            <p className="text">
              ...
              DEVELOPMENT. BY SUPPORTING THE TRULY HELP FOUNDATION BRIDGE, YOU
              ARE NOT ONLY HELPING THF ORGANIZATION REMAIN AN OPPORTUNITY FOR
              THE COUNTRY’S MARGINALIZED COMMUNITY.
            </p>
          </div>
        </div>
      </div>
